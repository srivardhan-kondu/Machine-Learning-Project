...
from src.utils import save_object  # Ensure this import is correct
...
class DataTransformation:
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            os.makedirs(os.path.dirname(self.data_transformation_config.preprocesser_obj_path), exist_ok=True)
